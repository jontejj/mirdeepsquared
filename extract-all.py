...
if __name__ == '__main__':
    #Small dataset
    os.system("python extract_features.py resources/result_30_10_2023_t_15_05_15.csv resources/output.mrd resources/dataset/true_positives_small.pkl -m resources/known-mature-sequences-h_sapiens.fas -tp")
    #True positives
