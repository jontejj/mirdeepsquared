...
python subset.py resources/dataset/hard/only_matching_mature_in_mirgene_db/tmp/true_positives_zebrafish_only_mature_in_mirgene_db.pkl resources/dataset/split/holdout/zebrafish.mature.2nd.run_only_in_mirgene_db.pkl resources/dataset/hard/only_matching_mature_in_mirgene_db/tricky_true_positives_zebrafish.pkl