...
python3 mirdeepsquared/train.py resources/dataset/split/train-val/train -o mirdeepsquared/models/ -hp mirdeepsquared/best-hyperparameters.yaml -tr trainer-results.csv
python3 -m build
twine upload dist/*
